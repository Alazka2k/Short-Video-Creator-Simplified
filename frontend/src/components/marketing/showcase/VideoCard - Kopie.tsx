  ...
  useEffect(() => {
    const fetchThumbnail = async () => {
      if (isYoutube) {
        ...
        // For TikTok, we'll use a placeholder design instead of trying to fetch thumbnails
        // This avoids CSP issues with TikTok's API
        setThumbnailUrl('')
      }
    }
        ...
        <div className="relative rounded-2xl overflow-hidden bg-card hover:shadow-xl transition-all duration-300">
          ...
          <div className="aspect-[9/16] w-full bg-black/90 relative group/play">
            {thumbnailUrl && isYoutube ? (
              ...
              // Styled placeholder for TikTok
              <div className="absolute inset-0 bg-gradient-to-br from-[#00f2ea]/20 to-[#ff0050]/20 flex items-center justify-center">
                <svg className="w-12 h-12 text-[#00f2ea]/70" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                </svg>
              </div>
            )}
