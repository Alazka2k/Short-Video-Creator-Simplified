  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        onClick={() => setSelectedContent(prev => ({ ...prev, voice: !prev.voice }))}
        >
        ...
        onClick={() => setSelectedContent(prev => ({ ...prev, visuals: !prev.visuals }))}
        >
          <CardContent className="p-4 flex items-center gap-4">
            <Image className={cn(
              "w-8 h-8",
        ...
        onClick={() => setSelectedContent(prev => ({ ...prev, music: !prev.music }))}
        >
          <CardContent className="p-4 flex items-center gap-4">
            <Music className={cn(
              "w-8 h-8",
